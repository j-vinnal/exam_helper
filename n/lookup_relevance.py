...
try:
    LEXICON = json.loads(Path("C:\\Projects\\stuff_25\\work\\jobs\\Telus2\\python\\new_json_rules\\exam_helper\\n\\lexicon_relevance.json").read_text(encoding="utf-8"))
except Exception:
    LEXICON = {}
...
def ask_missing_field(field: str, facts: Facts) -> None:
    if field == "exact_match":
        ...
        # Emphasize research: user should compare real-world chain locations to determine the appropriate tier
